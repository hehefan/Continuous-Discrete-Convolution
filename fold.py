...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='/tmp/protein/fold', type=str, metavar='N', help='data root directory')
...
if __name__ == '__main__':
    ...
    print(f'Best: {best_epoch+1:03d}, Validation: {best_valid_acc:.4f}, Fold: {best_fold_acc:.4f}, Family: {best_family_acc:.4f}, Super: {best_super_acc:.4f}, Valided Fold: {best_fold:.4f}, Valided Family: {best_family:.4f}, Valided Super: {best_super:.4f}')
    if args.ckpt_path:
