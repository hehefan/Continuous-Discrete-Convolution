...
from datasets import ECDataset
...
if __name__ == '__main__':
    ...
    train_dataset = ECDataset(root=args.data_dir, random_seed=args.seed, split='train')
    valid_dataset = ECDataset(root=args.data_dir, random_seed=args.seed, split='valid')
    test_dataset_30 = ECDataset(root=args.data_dir, random_seed=args.seed, percent=30, split='test')
    test_dataset_40 = ECDataset(root=args.data_dir, random_seed=args.seed, percent=40, split='test')
    test_dataset_50 = ECDataset(root=args.data_dir, random_seed=args.seed, percent=50, split='test')
    test_dataset_70 = ECDataset(root=args.data_dir, random_seed=args.seed, percent=70, split='test')
    test_dataset_95 = ECDataset(root=args.data_dir, random_seed=args.seed, percent=95, split='test')
