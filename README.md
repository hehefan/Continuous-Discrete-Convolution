...
CDConv is improved by integrating a few other techniques or tricks. The accuracy can be slightly higher than those numbers reported in the published ICLR23 paper on some tasks. 
